...
void loadData(const char *filename, sdds::Autoshop &as)
{
	...
	while (file)
	{
		// TODO: This code can throw errors to signal that something went wrong
		// while
		//         extracting data. Write code to catch and handle the following
		//         errors:
		//       - the type of vehicle is not recognized: the first non-empty
		//       character
		//           on the line is not 'c', 'C', 'r', or 'R'. In this case
		//           print "Unrecognized record type: [TAG]<endl>"
		//       - one of the fields in the record contains invalid data. In
		//       this case print
		//           "Invalid record!<endl>"
		try
		{
